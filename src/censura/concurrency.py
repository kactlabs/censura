...
from censura import WriteBack, format_file_in_place
from censura.cache import Cache
from censura.mode import Mode
from censura.output import err
from censura.report import Changed, Report
...
def maybe_install_uvloop() -> None:
    ...
    interfering with the parent process if Censura is used as a library.
    """
    try:
        import uvloop
...
def reformat_many(
    ...
    if workers is None:
        workers = int(os.environ.get("CENSURA_NUM_WORKERS", 0))
    ...
    if getattr(sys, "frozen", False):
        ...
        # See https://github.com/psf/supergreen/issues/4823
        workers = 1
