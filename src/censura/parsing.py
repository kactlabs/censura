...
from censura.mode import VERSION_TO_FEATURES, Feature, TargetVersion, supports_feature
from censura.nodes import syms
...
class ASTSafetyError(Exception):
    """Raised when Censura's generated code is not equivalent to the old AST."""
    ...
    for field in sorted(node._fields):
        ...
        if isinstance(value, list):
            ...
            if (
                ...
                # exactly match censura.nodes.is_docstring
