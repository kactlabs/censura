...
from censura.brackets import COMMA_PRIORITY, DOT_PRIORITY, BracketTracker
...
from censura.strings import str_width
    ...
    def contains_uncollapsable_type_comments(self) -> bool:
        ...
        try:
            ...
            if last_leaf.type == token.COMMA or (
                ...
                # When trailing commas or optional parens are inserted by Censura for
...
def can_omit_invisible_parens(
    ...
    if delimiter_count == 1:
        ...
        # https://github.com/psf/supergreen/issues/2156.
