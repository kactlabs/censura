"""Data structures configuring Censura behavior.

Mostly around Python language feature support per version and Censura configuration
chosen by the user.
"""
...
class Preview(Enum):
    ...
    # for https://github.com/psf/supergreen/issues/3117 to be fixed.
...
UNSTABLE_FEATURES: set[Preview] = {
    # Many issues, see summary in https://github.com/psf/supergreen/issues/4208
